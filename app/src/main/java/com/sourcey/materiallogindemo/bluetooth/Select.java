package com.sourcey.materiallogindemo.bluetooth;
...
import com.sourcey.materiallogindemo.SoothingSoundsList;
import com.sourcey.materiallogindemo.YogaPosesList;
import com.sourcey.materiallogindemo.YogaVideoList;
...
public class Select extends Activity implements PullToRefresh.OnRefreshListener {
    ...
    public void openYogavid(){
        Intent intent3 = new Intent(this, com.sourcey.materiallogindemo.YogaVideoList.class);
        startActivity(intent3);
    }

    public void openSounds(){
        Intent intent2 = new Intent(this, com.sourcey.materiallogindemo.SoothingSoundsList.class);
        startActivity(intent2);
    }

    public void openYogapose(){
        Intent intent1 = new Intent(this, com.sourcey.materiallogindemo.YogaPosesList.class);
